...
import { X, Eye, Edit, Shield, Trash2, User, Mail, Phone, MapPin, Calendar, ShoppingCart, DollarSign } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-gray-700/30 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-white font-bold text-lg sm:text-xl">{user.name}</h3>
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-start gap-3">
                        <ShoppingCart className="h-4 w-4 text-gray-400 mt-1" />
                        <div className="flex-1">
                          <Label className="text-gray-400 text-sm">Total Orders</Label>
                          <p className="text-white font-medium text-lg">{user.orders}</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-green-400 font-medium text-lg">${user.spent.toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-blue-600/20 p-4 rounded-lg border border-blue-500/30 text-center">
                <p className="text-blue-400 text-2xl font-bold">{user.orders}</p>
              ...
              <div className="bg-green-600/20 p-4 rounded-lg border border-green-500/30 text-center">
                <p className="text-green-400 text-2xl font-bold">${user.spent.toFixed(0)}</p>
                <p className="text-gray-300 text-sm">Spent</p>
              </div>
              <div className="bg-purple-600/20 p-4 rounded-lg border border-purple-500/30 text-center">
                <p className="text-purple-400 text-2xl font-bold">
                  {user.orders > 0 ? Math.round(user.spent / user.orders) : 0}
                </p>
